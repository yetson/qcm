...
//                }
    ...
    UM.registerWidget('image', {
        tpl:'<div class="edui-modal-footer"><div class="edui-modal-tip"></div><div class="edui-btn edui-btn-primary" data-ok="modal">确认</div><div class="edui-btn" data-hide="modal">取消</div></div>'
            +
